...
3. 获取候选人后，就要开展筛选工作。然后你只要简单总结一下你的安排(200字以内)，然后安排招聘顾问处理（直接对话即可安排招聘顾问）。
4. 请认真观察招聘顾问的处理结果的汇报，如果招聘顾问没有按照预期处理候选人，则停止整个流程。
    - 如果返回的数据没有包含候选人stage信息，则视为失败，则立即停止并通知用户检查招聘顾问是否正常运行(finish_tool)。
