...
DEFAULT_PROMPTS = {
    "chat": """请根据上述沟通历史，生成下一条跟进消息。
    - 如果候选人匹配度非常高（9分），抓住岗位和候选人的匹配度，吸引候选人回复。
    - 如果候选人有问题，可以回复候选人的问题。
    - 如果简历有不清晰的地方，请直接提出问题，让候选人回答、澄清。
    不要超过100字，且能够直接发送给候选人的文字，不要发模板或者嵌入占位符。请用纯文本回复，不要使用markdown、json格式。
    """,
