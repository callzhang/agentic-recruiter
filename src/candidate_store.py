...
_all_fields = [f.name for f in fields if f.name != "resume_vector"]
...
class CandidateStore:
    ...
    def get_candidate_by_id(self, chat_id = None, candidate_id = None, thread_id = None, fields: Optional[List[str]] = _all_fields) -> Optional[Dict[str, Any]]:
